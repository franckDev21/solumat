  ...
  <table class="min-w-full w-full table-auto mb-14">
    <thead>
        <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
            <th class="py-3 px-4 text-left">Nom du projet</th>
            <th class="py-3 px-4 text-left">Date</th>
            <th class="py-3 px-4 text-left">Durée du projet</th>
            ...
            <tr class="border-b border-gray-200 hover:bg-gray-100">
                <td class="py-3 px-4 text-left whitespace-nowrap ">
                    <div class="flex items-center">
                        ...
                        <div class="flex items-start flex-col justify-start py-1 {}scrollbar-none ">
                ...
                <td class="py-3 px-4 text-left">
                    <span>{{ $product->duree }}</span>
                </td>

                <td class="py-3 text-left">
                    <div class="flex item-center justify-start px-4">
                        <a href="{{ route('project.show', $product->id) }}"
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-6 text-center">
                    ...
                    <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Voulez vous vraiment
                        supprimer le projet  <span class="mot text-primary"></span> ?</h3>
        ...
        <script defer>
            ...
            Array.from(document.querySelectorAll('.delete-btn')).forEach(element => {
                ...
                element.addEventListener('click', e => {
                    form.setAttribute('action', `/projects/${e.currentTarget.dataset.id}`)
