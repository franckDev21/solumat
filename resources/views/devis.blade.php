  ...
  <div class="container px-10 mb-10">
    ...
    @else
      ...
      <form action="{{ route('devis.send') }}" class="w-full" method="POST">
        @csrf
        <div class="flex space-x-5 mb-8 mt-10">
        ...
        <div class="my-4">
          ...
          <select name="service" class="px-4 py-4 rounded-md w-full bg-gray-200 outline-none ring-0 border-0 focus:ring-0" id="service">
            @foreach (['Création & Entretien des piscines','Vente des produits d\'entretien','Plomberie','Réalisation des forages & traitement des eaux','Peinture bâtiment','Vidange des fosses'] as $item)
